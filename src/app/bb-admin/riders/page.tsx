...
export default function AdminRidersPage() {
  ...
  function RiderAvatar({ rider, size = 'md' }: { rider: RiderWithStats; size?: 'sm' | 'md' | 'lg' }) {
    ...
    return (
      <div className={`${sizeClass} rounded-full bg-[rgba(255,255,255,0.08)] flex items-center justify-center flex-shrink-0`}>
        <Profile size={20} color="#a1a4a5" />
      </div>
    );
  }
