...
import { Profile, Building, ArrowLeft2, Refresh2 } from 'iconsax-react';
...
function PersonIcon({ selected }: { selected: boolean }) {
  return <Profile size={32} color={selected ? '#F2FF66' : '#a1a4a5'} />;
}

function BuildingIcon({ selected }: { selected: boolean }) {
  return <Building size={32} color={selected ? '#F2FF66' : '#a1a4a5'} />;
}
